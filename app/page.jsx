export default function Home() {
  return (
    <>
      <main className="relative h-[85vh] text-white sm:h-[100vh]">
        <h1 className="absolute left-0 z-50 m-4 flex cursor-default items-center gap-2 text-xl text-slate-300">
          FB
          <div className="flex h-1 w-1 rounded-full bg-orange-600"></div>
          IN
        </h1>

        <h1 className="absolute left-1/2 top-0 z-50 my-2 -translate-x-1/2 cursor-pointer border-b-2 border-slate-300 text-3xl font-bold text-white transition-all duration-700 hover:border-opacity-50 hover:text-slate-200">
          dreamy
        </h1>
  ...
  https://images.unsplash.com/photo-1509214686682-59f244a5f38a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div className="absolute top-1/3 z-50 translate-x-10 text-3xl sm:left-40 sm:translate-x-0 md:top-1/3 lg:left-[15%] lg:text-5xl">
          ...
          <p className="">Assistant</p>
          <p>
            <span className="absolute w-full text-sm leading-3 tracking-normal lg:left-56 lg:top-[3.8rem]">
              {" "}
              Your one stop-shop agency to{" "}
            </span>
            <span className="absolute top-20 text-sm lg:left-[14.1rem] lg:top-[4.5rem]">
              {" "}
      ...
      <section className="bg-black px-8 py-32 pb-2 text-white sm:px-32">
        <h1 className="px-8 text-4xl">Our Services</h1>

        <ul className="my-8 grid grid-cols-1 gap-12 py-2 lg:grid-cols-3">
          <li className="flex flex-col gap-2 rounded-md border-slate-700 p-2">
          ...
          <li className="flex flex-col gap-2 rounded-md border-slate-700 p-2">
            <p className="text-slate-100">Catering</p>
            <p className="text-sm leading-5 tracking-tight text-gray-400">
          ...
          <li className="flex flex-col gap-2 rounded-md border-slate-700 p-2">
            <p className="text-slate-100">Photography Services</p>
            <p className="text-sm leading-5 tracking-tight text-gray-400">
      ...
      <section className="bg-black px-8 py-24 pb-2 text-white sm:px-32">
        <h1 className="px-8 text-4xl">Our Team</h1>

        <ul className="grid grid-cols-1 place-items-center gap-16 py-8 sm:grid-cols-2 md:grid-cols-3 md:place-items-baseline lg:grid-cols-4 lg:gap-2 lg:px-16">
...
"
            ...
            />
            <div className="absolute inset-0 bg-black/20"></div>
            <p className="">Alexander Skylar</p>
          </li>
...
"
      ...
      <section className="bg-black py-40">
        <div className="relative mx-auto flex w-2/3 items-center justify-center">
          <div className="flex flex-col gap-4 lg:-ml-4 xl:flex-row">
            <img
              className="h-60 rounded-xl opacity-80 xl:h-52 transition-all duration-500 hover:scale-105 cursor-pointer"
          ...
          <div className="absolute -bottom-36 text-gray-300 lg:w-[34rem]">
        ...
        <p className="mx-auto mt-36 w-3/4 py-8 text-sm leading-5 tracking-normal text-gray-300/80 sm:mt-0 sm:w-2/4 sm:translate-y-36 lg:w-1/3">
      ...
      <section className="bg-black py-32 text-white lg:px-64">
        <h1 className="px-12 pb-8 text-3xl lg:px-0">Our Delicious Cuisine</h1>

        <ul className="grid grid-cols-1 gap-20">
          <li className="relative flex flex-col gap-2 sm:flex-row">
            <img
              className="h-96 w-full rounded-md sm:h-80 sm:w-80"
            ...
            <div>
              <h1 className="z-50 mx-auto my-8 py-1 text-center text-2xl font-bold text-gray-300">
                Exquisite Culinary Creations
              </h1>
              <p className="mx-auto w-3/4 text-sm">
          ...
          <li className="relative flex flex-col gap-2 sm:flex-row">
            ...
            <img
              className="h-96 w-full rounded-md sm:h-96 sm:w-96"
      ...
      <section className="bg-black px-16 py-2 pb-32">
        <h1 className="text-3xl text-white sm:px-32 lg:px-60">Contact Us</h1>

        <ul className="-ml-6 grid grid-cols-1 gap-4 py-16 sm:-ml-0 sm:grid-cols-2 md:px-12 lg:mx-auto lg:w-3/4">
          <div className="relative">
            <img
              className="-ml-0 rounded-lg sm:-ml-6 sm:w-full lg:h-96 lg:w-96"
          ...
          <li>
            <div className="flex flex-col gap-8 px-4 py-14 xl:w-2/4 text-xs">
              <input
                className="text-md rounded-md border border-slate-700 bg-transparent px-3 py-1 text-slate-200 outline-none transition-all placeholder:opacity-50 focus:border-gray-600"
                placeholder="Name: "
                type="text"
                name=""
                id=""
              ...
              <textarea
                ...
                className="text-md h-32 resize-none rounded-md border border-slate-700 bg-transparent px-3 py-1 text-slate-200 outline-none transition-all placeholder:opacity-50 focus:border-gray-600"
              ></textarea>

              <button
                type="button"
                className="text-white bg-gradient-to-r from-fuchsia-600 to-indigo-700 rounded-md py-2 px-8 w-40 cursor-pointer hover:scale-110 transition-all duration-500"
              >
                Submit
              </button>
            </div>
      ...
      <footer className="relative bg-black pb-16 pt-40">
        ...
        <ul className="flex flex-row gap-2 px-6 text-sm">
          <li className="h-fit w-fit cursor-pointer border-b-[1px] border-slate-500 border-opacity-0 text-[#868e96] transition-all hover:scale-125">
            <img
              alt="Tiktok Icon"
